...
{
    [CreateAssetMenu(menuName = "Finite Attack Machine/Player/Decision/from Null/to Type 1",fileName = "new Null Decision Data")]
    public class IsPlayerAttackingType1FromNull : PlayerAttackDecision
    {
